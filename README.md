...
<li>
<p dir="auto"><g-emoji class="g-emoji" alias="dancers" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/1f46f.png">👯</g-emoji> My Fun Fact is <strong>Api &amp; Team</strong></p>
</li>

<li>
<p dir="auto"><g-emoji class="g-emoji" alias="speech_balloon" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/1f4ac.png">💬</g-emoji> Ask me about <strong>all things</strong></p>
</li>
...
<pre><span class="pl-v">About</span> <span class="pl-v">Me</span> <span class="pl-c1">=</span> [
    ...
    <span class="pl-s">"A know about of Python, HTML. CSS, PHP, JS, and Much More ...!"</span>,
