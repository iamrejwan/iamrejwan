...
<pre><span class="pl-v">About</span> <span class="pl-v">Me</span> <span class="pl-c1">=</span> [
    ...
    <span class="pl-s">"A know about of Kotlin, Python, HTML, CSS, Java, JS, Cura, Meshmixer and ...!"</span>,
    <span class="pl-s">"New Things with code everyday"</span>,
    <span class="pl-s">"I am in my world !! 💞"</span> ]</pre>

<p align="center" dir="auto"> 
<code>
<a href="https://www.oracle.com/java/" target="_blank" rel="noreferrer"><img src="https://raw.githubusercontent.com/danielcranney/readme-generator/main/public/icons/skills/java-colored.svg" width="40" height="40" alt="Java" /></a></code>&nbsp;
<code>
